...
| Release | Published | arm64-v8a | armeabi-v7a | x86_64 | x86 | universal |
|---|---|---|---|---|---|---|
...
- **arm64-v8a** — most Android phones and tablets from the last several years.
- **armeabi-v7a** — older 32-bit ARM devices.
- **x86_64** / **x86** — Intel/AMD devices and emulators.
- **universal** — works on all of the above; larger download. Pick this if you are not sure.

**smartide-eap** is the early-access build of SmartIDE (`org.smartide.code.eap`). It installs alongside the Play Store app and keeps its own data.
